...
cljs.core.nil_iter = function() {
  "undefined" === typeof cljs.core.t_cljs$core10551 && (cljs.core.t_cljs$core10551 = function(a) {
    this.meta10552 = a;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core10551.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
    return new cljs.core.t_cljs$core10551(b);
  }, cljs.core.t_cljs$core10551.prototype.cljs$core$IMeta$_meta$arity$1 = function(a) {
    return this.meta10552;
  }, cljs.core.t_cljs$core10551.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core10551.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core10551.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core10551.getBasis = function() {
    return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null, "meta10552", "meta10552", -2052251892, null)], null);
  }, cljs.core.t_cljs$core10551.cljs$lang$type = !0, cljs.core.t_cljs$core10551.cljs$lang$ctorStr = "cljs.core/t_cljs$core10551", cljs.core.t_cljs$core10551.cljs$lang$ctorPrWriter = function(a, b, c) {
    return cljs.core._write(b, "cljs.core/t_cljs$core10551");
  }, cljs.core.__GT_t_cljs$core10551 = function(a) {
    return new cljs.core.t_cljs$core10551(a);
  });
  return new cljs.core.t_cljs$core10551(cljs.core.PersistentArrayMap.EMPTY);
};
...
var wordcount = {word:{}};
wordcount.word.O9 = new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, "0123456789".split(""), null);
wordcount.word.az = new cljs.core.PersistentVector(null, 26, 5, cljs.core.PersistentVector.EMPTY_NODE, "qwertyuiopasdfghjklzxcvbnm".split(""), null);
wordcount.word.AZ = new cljs.core.PersistentVector(null, 26, 5, cljs.core.PersistentVector.EMPTY_NODE, "QWERTYUIOPASDFGHJKLZXCVBNM".split(""), null);
wordcount.word.dict = cljs.core.concat.call(null, wordcount.word.O9, wordcount.word.az, wordcount.word.AZ);
wordcount.word.hashDict = cljs.core.reduce.call(null, function(a, b) {
  return cljs.core.assoc.call(null, a, b, !0);
}, cljs.core.PersistentArrayMap.EMPTY, wordcount.word.dict);
wordcount.word.inWord = function(a) {
  return !0 === cljs.core.get.call(null, wordcount.word.hashDict, a) ? !0 : !1;
};
wordcount.word.betweenWords = function(a) {
  return cljs.core.not.call(null, wordcount.word.inWord.call(null, a));
};
wordcount.frequencies = {};
wordcount.frequencies.core = {};
wordcount.frequencies.core.ofWords = function(a) {
  return cljs.core.println.call(null, "frequencies");
};
wordcount.simple = {};
wordcount.simple.core = {};
wordcount.simple.core.howManyWords = function(a) {
  for (var b = !1, c = 0;;) {
    var d = cljs.core.first.call(null, a);
    if (null == d) {
      return cljs.core.println.call(null, c);
    }
    var e = wordcount.word.inWord.call(null, d), d = e;
...
wordcount.all = {};
wordcount.all.core = {};
wordcount.all.core.stat = function(a) {
  for (var b = !1, c = a, d = 0, e = 0, f = 0;;) {
    var g = cljs.core.first.call(null, c);
    if (null == g) {
      return cljs.core.println.call(null, [cljs.core.str("line:"), cljs.core.str(e), cljs.core.str(", words:"), cljs.core.str(d), cljs.core.str(", chars:"), cljs.core.str(f)].join(""));
    }
    var h = wordcount.word.inWord.call(null, g);
    a = h;
...
wordcount.input = {};
wordcount.input.argv = cljs.core.drop.call(null, 2, cljs.core.js__GT_clj.call(null, process.argv));
wordcount.input.getData = function() {
  var a = cljs.core.last.call(null, wordcount.input.argv), a = require("fs").readFileSync(a, "utf8");
  return clojure.string.split.call(null, a, RegExp(""));
};
wordcount.input.getOption = function() {
  return cljs.core._EQ_.call(null, 2, cljs.core.count.call(null, wordcount.input.argv)) ? cljs.core.first.call(null, wordcount.input.argv) : "--simple";
};
wordcount.parallel = {};
wordcount.parallel.worker = {};
wordcount.parallel.worker.start = function(a) {
  var b = a.worker;
  a = b.process;
  var c = new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, "0123456789".split(""), null), d = new cljs.core.PersistentVector(null, 26, 5, cljs.core.PersistentVector.EMPTY_NODE, "qwertyuiopasdfghjklzxcvbnm".split(""), null), e = new cljs.core.PersistentVector(null, 26, 5, cljs.core.PersistentVector.EMPTY_NODE, "QWERTYUIOPASDFGHJKLZXCVBNM".split(""), null), f = cljs.core.concat.call(null, c, d, e), g = cljs.core.reduce.call(null, function(a, b, c, d, e, f) {
    return function(a, b) {
      return cljs.core.assoc.call(null, a, b, !0);
    };
  }(b, a, c, d, e, f), cljs.core.PersistentArrayMap.EMPTY, f), h = function(a, b, c, d, e, f, g) {
    return function(a) {
      return !0 === cljs.core.get.call(null, g, a) ? !0 : !1;
    };
  }(b, a, c, d, e, f, g), b = function(a, b, c, d, e, f, g, h) {
    return function(k) {
      ...
      b.send(l.call(null, cljs.core.js__GT_clj.call(null, k)));
      return a.kill();
    };
  }(b, a, c, d, e, f, g, h);
  return a.on("message", b);
};
wordcount.parallel.split = {};
wordcount.parallel.split.split = function(a) {
  for (var b = cljs.core.count.call(null, a), b = (cljs.core.odd_QMARK_.call(null, b) ? b - 1 : b) / 2;;) {
    if (cljs.core._EQ_.call(null, b, 0)) {
      return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [a], null);
    }
    var c = cljs.core.nth.call(null, a, b);
    return cljs.core.truth_(wordcount.word.betweenWords.call(null, c)) ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.take.call(null, b, a), cljs.core.drop.call(null, b, a)], null) : null;
  }
};
wordcount.parallel.core = {};
wordcount.parallel.core.howManyWords = function(a) {
  var b = require("cluster");
  return cljs.core.truth_(b.isMaster) ? cljs.core.add_watch.call(null, cljs.core.reduce.call(null, function(a) {
    return function(b, c) {
      var d = a.fork();
      cljs.core.swap_BANG_.call(null, b, cljs.core.update_in, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "notFinish", "notFinish", -1855011242)], null), cljs.core.inc);
      d.on("online", function(a, b) {
        return function() {
          return a.send(cljs.core.clj__GT_js.call(null, c));
        };
      }(d, a));
      d.on("message", function(a, c) {
        return function(d) {
          cljs.core.swap_BANG_.call(null, b, cljs.core.update_in, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "wordcount", "wordcount", 561541096)], null), function(a, b) {
            return function(a) {
              return a + d;
            };
          }(a, c));
          return cljs.core.swap_BANG_.call(null, b, cljs.core.update_in, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "notFinish", "notFinish", -1855011242)], null), cljs.core.dec);
        };
      }(d, a));
      return b;
    };
  }(b), cljs.core.atom.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "wordcount", "wordcount", 561541096), 0, new cljs.core.Keyword(null, "notFinish", "notFinish", -1855011242), 0], null)), wordcount.parallel.split.split.call(null, a)), "ready", function(a) {
    return function() {
      var a = function(a) {
        a = cljs.core.last.call(null, a);
        return cljs.core._EQ_.call(null, (new cljs.core.Keyword(null, "notFinish", "notFinish", -1855011242)).cljs$core$IFn$_invoke$arity$1(a), 0) ? cljs.core.println.call(null, (new cljs.core.Keyword(null, "wordcount", "wordcount", 561541096)).cljs$core$IFn$_invoke$arity$1(a)) : null;
      }, b = function(b) {
        var c = null;
        if (0 < arguments.length) {
          for (var c = 0, d = Array(arguments.length - 0);c < d.length;) {
  ...
  }(b)) : wordcount.parallel.worker.start.call(null, b);
};
wordcount.core = {};
cljs.core.enable_console_print_BANG_.call(null);
wordcount.core.start = function() {
  var a = wordcount.input.getData.call(null), b = wordcount.input.getOption.call(null);
  return cljs.core._EQ_.call(null, b, "--simple") ? wordcount.simple.core.howManyWords.call(null, a) : cljs.core._EQ_.call(null, b, "--all") ? wordcount.all.core.stat.call(null, a) : cljs.core._EQ_.call(null, b, "--frequencies") ? wordcount.frequencies.core.ofWords.call(null, a) : cljs.core._EQ_.call(null, b, "--parallel") ? wordcount.parallel.core.howManyWords.call(null, a) : null;
};
cljs.core._STAR_main_cli_fn_STAR_ = wordcount.core.start;
cljs.nodejscli = {};
